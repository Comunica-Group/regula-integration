...
class DocumentReaderTab extends Component {
  constructor(props) {
    super(props);
    this.state = {
      serverVersion: null,
        ...
        {this.state.serverVersion && (
          <div className="document-info-container">
            ...
            <button
                className={`block3`}
                onClick={() => {
                    this.props.setActiveTab('FaceComparison');
                    this.props.setPortraitImageBase64(this.state.portraitImageBase64);
                }}
            >
                Compare Faces
            </button>
...
export default connect(mapStateToProps, { initialize })(DocumentReaderTab);
